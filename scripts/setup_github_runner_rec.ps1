...
<#
.SYNOPSIS
Installe et configure le runner GitHub Actions Windows pour P13-REC.

.DESCRIPTION
Script de setup du runner CI/CD du repo P13 effectifs scolaires:
- La branche dev deploie vers G:\GITHUB\P13-REC
...
param(
    ...
    [string]$RunnerName = "p13-rec-runner",
    [string]$RunnerDir = "G:\actions-runner\p13-rec",
    [string]$Labels = "self-hosted,windows,p13-deploy,p13-rec",
...
Clear-Host
Write-Info "========================================="
Write-Info "Setup Runner GitHub - P13-REC"
Write-Info "========================================="
...
Write-Info "Target deploy dir: G:\GITHUB\P13-REC"
Write-Info "Ports REC: API 18000 | Streamlit 18501 | MLflow 15000 | Jupyter 18888"
...
Write-Info ""
Write-Success "========================================="
Write-Success "Runner P13-REC pret"
Write-Success "========================================="
...
Write-Info "Ce runner executera le job deploy-dev (branche dev -> G:\GITHUB\P13-REC)."
